 ...
 * ```
 */
export declare const arrConcat: {
    <T>(theArray: T[]): T[];
 ...
 * ```
 */
export declare function arrIntersection<T>(...arrays: ArrayLike<T>[]): T[];
 ...
 * ```
 */
export declare const arrKeys: <T = any>(value: ArrayLike<T>) => IterableIterator<number>;
 ...
 * ```
 */
export declare function arrPartition<T, E extends T>(theArray: ArrayLike<T> | null | undefined, callbackFn: ArrPredicateCallbackFn<T, E> | ArrPredicateCallbackFn2<T>, thisArg?: any): [T[] | E[], T[]];
 ...
 * ```
 */
export declare const arrReverse: <T>(theArray: WritableArrayLike<T>) => WritableArrayLike<T>;
 ...
 * ```
 */
export declare function arrRotate<T>(theArray: ArrayLike<T> | null | undefined, count: number): T[];
 ...
 * ```
 */
export declare function arrSample<T>(theArray: ArrayLike<T> | null | undefined): T | undefined;
 ...
 * ```
 */
export declare function arrShuffle<T>(theArray: ArrayLike<T> | null | undefined): T[];
 ...
 * ```
 */
export declare function arrTake<T>(theArray: ArrayLike<T> | null | undefined, count: number): T[];
 ...
 * ```
 */
export declare function arrTakeWhile<T, E extends T = T>(theArray: ArrayLike<T> | null | undefined, callbackFn: ArrPredicateCallbackFn<T, E> | ArrPredicateCallbackFn2<T>, thisArg?: any): T[] | E[];
 ...
 * ```
 */
export declare function arrToMap<T>(values: ArrayLike<T> | Iterator<T> | Iterable<T>, keySelector: ArrToMapKeySelectorFn<T>): {
    [key: string]: T;
};

export declare function arrToMap<T, V>(values: ArrayLike<T> | Iterator<T> | Iterable<T>, keySelector: ArrToMapKeySelectorFn<T>, valueSelector: ArrToMapValueSelectorFn<T, V>): {
    [key: string]: V;
};
 ...
 * ```
 */
export declare type ArrToMapKeySelectorFn<T> = (value: T, index: number) => string | number;
 ...
 * ```
 */
export declare type ArrToMapValueSelectorFn<T, V = T> = (value: T, index: number) => V;
 ...
 * ```
 */
export declare function arrUnion<T>(...arrays: ArrayLike<T>[]): T[];
 ...
 * ```
 */
export declare function arrUnique<T>(theArray: ArrayLike<T> | null | undefined): T[];
 ...
 * ```
 */
export declare function arrUnzip(theArray: ArrayLike<ArrayLike<any>> | null | undefined): any[][];
 ...
 * ```
 */
export declare const arrWith: <T>(theArray: ArrayLike<T>, index: number, value: T) => T[];
 ...
 * ```
 */
export declare function arrZip(...arrays: ArrayLike<any>[]): any[][];
 ...
 */
export declare type BoundFunction<TFn extends (...args: any[]) => any, TArgs extends any[]> = TArgs extends [] ? TFn : TArgs extends [any] ? (TFn extends (a0: any, ...args: infer R) => infer RT ? (...args: R) => RT : (...args: any[]) => ReturnType<TFn>) : TArgs extends [any, any] ? (TFn extends (a0: any, a1: any, ...args: infer R) => infer RT ? (...args: R) => RT : (...args: any[]) => ReturnType<TFn>) : TArgs extends [any, any, any] ? (TFn extends (a0: any, a1: any, a2: any, ...args: infer R) => infer RT ? (...args: R) => RT : (...args: any[]) => ReturnType<TFn>) : TArgs extends [any, any, any, any] ? (TFn extends (a0: any, a1: any, a2: any, a3: any, ...args: infer R) => infer RT ? (...args: R) => RT : (...args: any[]) => ReturnType<TFn>) : TArgs extends [any, any, any, any, any] ? (TFn extends (a0: any, a1: any, a2: any, a3: any, a4: any, ...args: infer R) => infer RT ? (...args: R) => RT : (...args: any[]) => ReturnType<TFn>) : (...args: any[]) => ReturnType<TFn>;
 ...
 * ```
 */
export declare function createCustomError<T extends ErrorConstructor = CustomErrorConstructor, B extends ErrorConstructor = ErrorConstructor>(name: string, constructCb?: ((this: any, self: any, args: IArguments, isOwnInstance?: boolean) => void) | null, errorBase?: B, superArgsFn?: ((args: IArguments) => ArrayLike<any>) | null): T;
 ...
 * ```
 */
export declare function createIterableIterator<T>(ctx: CreateIteratorContext<T>): IterableIterator<T>;
 ...
 * ```
 */
export declare function createLiteralRegex(matcher: string): RegExp;
 ...
 * ```
 */
export declare type DeepPartial<T> = T extends Function ? T : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial<U>> : T extends object ? {
 ...
 * ```
 */
export declare type DeepReadonly<T> = T extends Function ? T : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepReadonly<U>> : T extends object ? {
 ...
 * ```
 */
export declare type DeepRequired<T> = T extends Function ? T : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepRequired<NonNullable<U>>> : T extends object ? {
 ...
 * ```
 */
export declare function fnBind<F extends (...args: any[]) => any, T>(fn: F, thisArg: T): F;
 ...
 * ```
 */
export declare function fnBind<F extends (...args: any[]) => any, T, TArgs extends any[]>(fn: F, thisArg: T, ...argArray: TArgs): BoundFunction<F, TArgs>;
 ...
 * ```
 */
export declare function fnBindArgs<F extends (...args: any[]) => any, T, TArgs extends any[]>(fn: F, thisArg: T, argArray: TArgs): BoundFunction<F, TArgs>;

export declare function fnBindArgs<F extends (...args: any[]) => any, T>(fn: F, thisArg: T): F;
 ...
 * ```
 */
export declare function forEachOwnKey<T>(theObject: T, callbackfn: (key: PropertyKey, value: T[keyof T]) => void | number, thisArg?: any): void;
 ...
 * ```
 */
export declare function forEachOwnKeySafe<T>(theObject: T, callbackfn: (key: PropertyKey, value: T[keyof T]) => void | number, thisArg?: any): void;
 ...
 * ```
 */
export declare const getLength: <T extends IGetLength>(value: T) => T["length"];
 ...
 * ```
 */
export declare const getProcessNextTick: () => ProcessNextTickFn;
 ...
 * ```
 */
export declare const getQueueMicrotask: () => ScheduleMicrotaskFn;
 ...
 * ```
 */
export declare function hasProcessNextTick(): boolean;
 ...
 * ```
 */
export declare function hasQueueMicrotask(): boolean;
 ...
 * ```
 */
export declare function isArrayLike(arg: any): arg is ArrayLike<any>;
 ...
 * ```
 */
export declare function isAsyncIterable<T = any>(value: any): value is AsyncIterable<T>;
 ...
 * ```
 */
export declare function isDefined<T>(arg: any): arg is Exclude<T, undefined>;
 ...
 * ```
 */
export declare function isStrictNullOrUndefined(value: any): value is null | undefined;
 ...
 * ```
 */
export declare function isUnsafePropKey(key: PropertyKey): boolean;
 ...
 * ```
 */
export declare function isUnsafeTarget(target: any): boolean;
 ...
 * ```
 */
export declare function iterDifference<T>(iter: Iterator<T> | Iterable<T>, ...excludeIters: Array<Iterator<T> | Iterable<T>>): T[];
 ...
 * ```
 */
export declare function iterEvery<T>(iter: Iterator<T> | Iterable<T>, callbackfn: IterPredicateCallbackFn<T>, thisArg?: any): boolean;
 ...
 * ```
 */
export declare function iterFilter<T>(iter: Iterator<T> | Iterable<T>, callbackfn: IterPredicateCallbackFn<T>, thisArg?: any): IterableIterator<T>;
 ...
 * ```
 */
export declare function iterIntersection<T>(...iters: Array<Iterator<T> | Iterable<T>>): T[];
 ...
 * ```
 */
export declare function iterMap<T, R = T>(iter: Iterator<T> | Iterable<T>, callbackfn: IterMapCallbackFn<T, R>, thisArg?: any): IterableIterator<R>;
 ...
 * ```
 */
export declare type IterMapCallbackFn<T, R = T> = (value: T, index: number) => R;
 ...
 * ```
 */
export declare type IterPredicateCallbackFn<T> = (value: T, index: number) => unknown;
 ...
 * ```
 */
export declare function iterReduce<T, R = T>(iter: Iterator<T> | Iterable<T>, callbackfn: IterReduceCallbackFn<T, R>, initialValue?: T | R): R;
 ...
 * ```
 */
export declare type IterReduceCallbackFn<T, R = T> = (previousValue: T | R, currentValue: T, currentIndex: number, iter: Iterator<T>) => R;
 ...
 * ```
 */
export declare function iterSome<T>(iter: Iterator<T> | Iterable<T>, callbackfn: IterPredicateCallbackFn<T>, thisArg?: any): boolean;
 ...
 * ```
 */
export declare function iterTake<T>(iter: Iterator<T> | Iterable<T>, count: number): IterableIterator<T>;
 ...
 * ```
 */
export declare function iterToArray<T, R = T>(iter: Iterator<T> | Iterable<T> | ArrayLike<T>, mapFn?: IterMapCallbackFn<T, R>, thisArg?: any): R[];
 ...
 * ```
 */
export declare function iterUnion<T>(...iters: Array<Iterator<T> | Iterable<T>>): T[];
 ...
 * @group Environment
 */
export declare type MicrotaskFn = () => void;
 ...
 * @group Timer
 */
export declare interface MicroTaskOptions {
    /**
 ...
 * @group Timer
 */
export declare interface NextTickOptions {
    /**
 ...
 * ```
 */
export declare function objDefaults<T>(target: T, ...sources: Array<Partial<T> | null | undefined>): T;
 ...
 * ```
 */
export declare function objDiff<T, U extends Partial<T> = Partial<T>>(base: T, modified: U): Partial<U>;
 ...
 * ```
 */
export declare function objForEachKeySafe<T>(theObject: T, callbackfn: (key: string, value: T[keyof T]) => void | number, thisArg?: any): void;
 ...
 * ```
 */
export declare function objMapValues<T, U>(source: T, mapper: (value: T[keyof T], key: PropertyKey) => U): {
    [K in keyof T]: U;
};
 ...
 * ```
 */
export declare function objMergeIf<T>(target: T, source: Record<PropertyKey, any> | null | undefined, predicate: (key: PropertyKey, srcValue: any, tgtValue: any) => boolean): T;
 ...
 * ```
 */
export declare function objOmit<T, K extends keyof T>(source: T, keys: ArrayLike<K>): Pick<T, Exclude<keyof T, K>>;

export declare function objOmit<T>(source: T, keys: ArrayLike<string>): Partial<T>;

export declare function objOmit<T>(source: T, keys: ArrayLike<PropertyKey>): Partial<T>;
 ...
 * ```
 */
export declare function objOmitBy<T>(source: T, predicate: (key: PropertyKey, value: T[keyof T]) => boolean): Partial<T>;
 ...
 * ```
 */
export declare function objPick<T, K extends keyof T>(source: T, keys: ArrayLike<K>): Pick<T, K>;

export declare function objPick<T>(source: T, keys: ArrayLike<string>): Partial<T>;

export declare function objPick<T>(source: T, keys: ArrayLike<PropertyKey>): Partial<T>;
 ...
 * ```
 */
export declare function objPickBy<T>(source: T, predicate: (key: PropertyKey, value: T[keyof T]) => boolean): Partial<T>;
 ...
 * @group Environment
 */
export declare type ProcessNextTickFn = (callback: (...args: any[]) => void, ...args: any[]) => void;
 ...
 * ```
 */
export declare function scheduleMicrotask(callback: () => void, options?: MicroTaskOptions): ITimerHandler;

export declare function scheduleMicrotask<TArgs extends any[]>(callback: (...args: TArgs) => void, args: TArgs, options?: MicroTaskOptions): ITimerHandler;
 ...
 */
export declare type ScheduleMicrotaskFn = (callback: MicrotaskFn, maxQueuedTasks?: number) => void | boolean;
 ...
 * ```
 */
export declare function scheduleNextTick(callback: MicrotaskFn, options?: NextTickOptions): ITimerHandler;

export declare function scheduleNextTick<TArgs extends any[]>(callback: (...args: TArgs) => void, args: TArgs, options?: NextTickOptions): ITimerHandler;
 ...
 * ```
 */
export declare function setMicroTaskFallbackOptions(options?: MicroTaskOptions): void;
 ...
 * ```
 */
export declare function setNextTickFallbackOptions(options?: NextTickOptions): void;
 ...
 * ```
 */
export declare const strAt: (value: string, index: number) => string | undefined;
 ...
 * ```
 */
export declare function strCapitalizeWords<T>(value: T): string;
 ...
 * ```
 */
export declare function strCount(value: string, searchString: string): number;
 ...
 * @throws TypeError If value is null or undefined.
 */
export declare function strEndsWithAny(value: string, searchValues: ArrayLike<string>, length?: number): boolean;
 ...
 * ```
 */
export declare const strMatchAll: (value: string, matcher: string | RegExp) => IterableIterator<RegExpExecArray>;
 ...
 */
export declare function strNormalizeNewlines(value: string, newlineType?: "\n" | "\r\n" | "\r" | "\n\r"): string;
 ...
 * ```
 */
export declare const strReplace: (value: string, searchValue: string | RegExp, replaceValue: string | ((substring: string, ...args: any[]) => string)) => string;
 ...
 * ```
 */
export declare const strReplaceAll: (value: string, searchValue: string | RegExp, replaceValue: string | ((substring: string, ...args: any[]) => string)) => string;
 ...
 * @throws TypeError If value is null or undefined.
 */
export declare function strStartsWithAny(value: string, searchValues: ArrayLike<string>, position?: number): boolean;
 ...
 * ```
 */
export declare function strTruncate(value: string, maxLength: number, suffix?: string): string;
 ...
 * @throws TypeError If value is null or undefined.
 */
export declare function strUnwrap(value: string, prefix: string, suffix?: string): string;
 ...
 * @throws TypeError If value is null or undefined.
 */
export declare function strWrap(value: string, prefix: string, suffix?: string): string;
 ...
 * ```
 */
export declare interface WritableArrayLike<T> {
    length: number;
    [index: number]: T;
}
