        ...
        methods: [
            {
                ...
                statements: hasMultiSelectFields
                    ? [
                        `const result = await ${serviceName}.client.createRecordAsync<Record<string, unknown>, ${readTypeName}>(${serviceName}.dataSourceName, serializeMultiSelectPicklistFields(record as unknown as Record<string, unknown>, ${serviceName}.multiSelectPicklistFields));`,
                        `if (result.data) { deserializeMultiSelectPicklistFields(result.data as unknown as Record<string, unknown>, ${serviceName}.multiSelectPicklistFields); }`,
                        'return result;',
                    ]
                    : [
            ...
            },
            {
                ...
                statements: hasMultiSelectFields
                    ? [
                        `const result = await ${serviceName}.client.updateRecordAsync<Record<string, unknown>, ${readTypeName}>(${serviceName}.dataSourceName, id, serializeMultiSelectPicklistFields(changedFields as unknown as Record<string, unknown>, ${serviceName}.multiSelectPicklistFields));`,
                        `if (result.data) { deserializeMultiSelectPicklistFields(result.data as unknown as Record<string, unknown>, ${serviceName}.multiSelectPicklistFields); }`,
                        'return result;',
                    ]
                    : [
            ...
            },
            {
                ...
                statements: hasMultiSelectFields
                    ? [
                        ...
                        `result.data?.forEach(record => deserializeMultiSelectPicklistFields(record as unknown as Record<string, unknown>, ${serviceName}.multiSelectPicklistFields));`,
                        'return result;',
                    ]
                    : [
                        `const result = await ${serviceName}.client.retrieveMultipleRecordsAsync<${readTypeName}>(${serviceName}.dataSourceName, options);`,
