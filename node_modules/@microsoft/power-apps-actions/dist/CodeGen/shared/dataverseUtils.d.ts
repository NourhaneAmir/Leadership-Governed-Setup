...
export declare function getDataverseOwnerColumnNames(propertiesNode: JsonObject): Set<string>;
/**
 ...
 */
export declare function isDataverseSystemManagedProperty(propName: string, propValue: JsonObject, ownerColumnNames: ReadonlySet<string>): boolean;
 ...
 */
export declare function escapeSingleQuotedString(str: string): string;
