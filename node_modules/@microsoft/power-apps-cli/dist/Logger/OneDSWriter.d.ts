...
export declare class OneDSWriter implements ITelemetryWriter {
    ...
    constructor(sessionId: string, region: Region, telemetryLocation: TelemetryLocation, environmentId: string, appId: string, geoLocation: string | undefined, cliVersion: string, cliSource: string, cliSurface: string);
