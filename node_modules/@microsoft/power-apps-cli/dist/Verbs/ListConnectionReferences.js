...
export async function listConnectionReferences(argumentProvider) {
    ...
    if (argumentProvider.isJsonMode()) {
        emitJsonList(argumentProvider, connectionReferences);
        return;
    }
    printKeyValueList({
...
function createOptionSchema(argumentProvider) {
    ...
    argumentProvider.addExamples(HelpStrings.Verbs['List-connection-references']);
