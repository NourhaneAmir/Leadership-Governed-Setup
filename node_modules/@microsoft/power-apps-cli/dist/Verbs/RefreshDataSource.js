...
export async function refreshDataSourceAsync(argumentProvider) {
    ...
    if (argumentProvider.isJsonMode() && argumentProvider.isGrouped()) {
        emitJson(argumentProvider, { succeeded: result.succeeded, failed: result.failed });
        return;
    }
...
function createOptionSchema(argumentProvider) {
    ...
    argumentProvider.addExamples(HelpStrings.Verbs['Refresh-data-source']);
