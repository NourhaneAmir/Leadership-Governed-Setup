...
export const CLI_CONFIG_DIRECTORY = getCliEnvVar('CONFIG_DIR') || path.join(os.homedir(), '.powerapps-cli');
...
// MSAL public-client app id for the Power Apps code apps CLI. Kept identical to the value
// previously inlined in NodeMsalAuthenticationProvider so existing cached tokens stay valid.
