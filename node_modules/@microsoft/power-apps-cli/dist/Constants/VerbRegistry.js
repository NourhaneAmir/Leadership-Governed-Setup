...
export const VERB_HELP_REGISTRY = {
    ...
    // Internal-only: functional but intentionally hidden from the customer-facing `--help` verb table
    // until the full migration flow (main-plan steps 1–7) is ready to expose.
    migrate: { description: HelpStrings.Verbs.Migrate.Description, internal: true },
    push: { description: HelpStrings.Verbs.Push.Description },
    share: { description: HelpStrings.Verbs.Share.Description },
    ...
    'list-connectors': { description: HelpStrings.Verbs['List-connectors'].Description },
