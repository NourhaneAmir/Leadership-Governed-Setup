...
import { NetworkError } from '../Errors/CliError.js';
/**
...
export function enhanceNetworkError(error, method, url) {
    if (!(error instanceof TypeError) || !error.message.includes('fetch failed')) {
        // Not a fetch failure, return original error (typed CLI errors pass through unchanged).
    ...
    const enhancedError = new NetworkError(detailedMessage, 'Check your network connection, VPN/proxy, and that the target service is reachable.');
